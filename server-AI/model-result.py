...
exercise_name = 'Plank-side'.lower() #(sys.argv[1]).lower()
image_folder_path = r'D:\AI\dataset_cut\validation\face\Flank\011\558-Z59_C' #sys.argv[2]
json_path = 'E:/AImodel/models/Multilabel/model-server/label_data.json' #'label_data.json'
model = (tf.keras.models.load_model(f'E:/AImodel/models/Multilabel/model-server/{exercise_name}.h5'))
